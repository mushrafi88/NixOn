...
-- personal imports
-- ]
local tex = require("LuaSnip.tex.utils.conditions")
local auto_backslash_snippet = require("LuaSnip.tex.utils.scaffolding").auto_backslash_snippet
local symbol_snippet = require("LuaSnip.tex.utils.scaffolding").symbol_snippet
local single_command_snippet = require("LuaSnip.tex.utils.scaffolding").single_command_snippet
local postfix_snippet = require("LuaSnip.tex.utils.scaffolding").postfix_snippet
