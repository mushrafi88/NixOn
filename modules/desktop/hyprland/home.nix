...

{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
             ...
             windowrule=workspace name:S silent, title:Telegram
             ...
             windowrule=workspace 3,noblur,firefox
      	     windowrule=workspace 3,noblur, title:Window Rules | Hyprland Wiki - LibreWolf
